import { Context, Points, ForceFields, Style, XY } from "./sacred.types";
...
export function CoverEcho(ctx: Context, points: Points, forceFields: ForceFields) {
	for (let p of points()) {
		...
		let symbolsMinor = [
			...
			[
				(_f) => Symbols.FruitOfSimplicity_Chaotic(ctx, {...xy}, {...style, fill: false, stroke: colorsf.blackOrangish(_f)}, _f),
				(_f) => Symbols.FruitOfSimplicity_Chaotic(ctx, {...xy, r: xy.r * 1.2}, {...style, fill: false, strokeWidth: style.strokeWidth * 0.6, stroke: colorsf.blackOrangish(_f)}, _f),
				(_f) => Symbols.FruitOfSimplicity_Chaotic(ctx, {...xy, r: xy.r * 1.4}, {...style, fill: false, strokeWidth: style.strokeWidth * 0.3, stroke: colorsf.blackOrangish(_f)}, _f),
			],
